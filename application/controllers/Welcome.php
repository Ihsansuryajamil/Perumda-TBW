...
class Welcome extends CI_Controller {
	...
	{		
		$data['mitra_bank'] = $this->db->query("SELECT * FROM daftarMitra WHERE kategori = 'Bank'")->result();
    	$data['mitra_ecommerce'] = $this->db->query("SELECT * FROM daftarMitra WHERE kategori = 'E-Commerce'")->result();
		...
		// data statistik
		$data['statistik'] = $this->m_data->get_data('statistik')->result(); // Tambahkan data statistik
		...
		$this->load->view('frontend/v_footer', $data); // Pastikan data statistik dikirim ke footer
	}
	...
	public function sejarah()
	{
		...
		$this->load->view('frontend/v_header', $data);
		$this->load->view('frontend/v_sejarah', $data);  // Create a new view file 'v_sejarah.php'
