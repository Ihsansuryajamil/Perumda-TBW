...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url(); ?>assets/index2.html">Login <b>Dashboard</b></a>
    </div>
    <!-- /.login-logo -->
    ...
    <div class="login-box-body">
      <p class="login-box-msg">tirta bumi wibawa kota sukabumi</p>

      <form action="<?php echo base_url().'index.php/login/aksi' ?>" method="post">
