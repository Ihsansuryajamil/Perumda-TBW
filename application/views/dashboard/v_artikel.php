	...
	<section class="content">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<?php echo base_url().'index.php/dashboard/artikel_tambah'; ?>" class="btn btn-sm btn-primary">Buat <strong>artikel baru</strong></a>
				<?php 
					if($this->session->userdata('level') == "admin"){
					?>
						<a href="<?php echo base_url().'index.php/dashboard/kategori'; ?>" class="btn btn-sm btn-success">Tambah <strong>Kategori Baru</strong></a>
				<?php
					} 
					?>
				<br/>
											...
											// cek apakah penggun yang login adalah penulis
												...
												// jika penulis, maka cek apakah penulis artikel ini adalah si pengguna atau bukan
													if($this->session->userdata('id') == $a->artikel_author){
														?>
														<a href="<?php echo base_url().'index.php/dashboard/artikel_edit/'.$a->artikel_id; ?>" class="btn btn-warning btn-sm"> <i class="fa fa-pencil"></i> </a>
														<a href="<?php echo base_url().'index.php/dashboard/artikel_hapus/'.$a->artikel_id; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
														<?php
													}
												}else{
