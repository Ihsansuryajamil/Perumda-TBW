<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-lg-6">
				<a href="<?php echo base_url().'index.php/dashboard/pengguna'; ?>" class="btn btn-sm btn-primary">Kembali</a>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<form method="post" action="<?php echo base_url('index.php/dashboard/pengguna_hapus_aksi') ?>">
							<div class="box-body">
